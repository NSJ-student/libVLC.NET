...
namespace LibVLC.NET
{
  ...
  partial class LibVLCLibrary
  {
    ...
    */
    ...
    //==========================================================================
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate void libvlc_media_player_set_hwnd_signature(IntPtr mp, IntPtr drawable);

    //==========================================================================
    private readonly libvlc_media_player_set_hwnd_signature m_libvlc_media_player_set_hwnd;

    //==========================================================================
    public void libvlc_media_player_set_hwnd(IntPtr p_mi, IntPtr drawable)
    {
        VerifyAccess();

        m_libvlc_media_player_set_hwnd(p_mi, drawable);
    }
    ...
    //==========================================================================
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    private delegate IntPtr libvlc_media_player_get_hwnd_signature(IntPtr mp);

    //==========================================================================
    private readonly libvlc_media_player_get_hwnd_signature m_libvlc_media_player_get_hwnd;

    //==========================================================================
    public IntPtr libvlc_media_player_get_hwnd(IntPtr p_mi)
    {
        VerifyAccess();

        return m_libvlc_media_player_get_hwnd(p_mi);
    }
